...
class Habitante(models.Model):
    ...
    nombre = models.CharField(max_length=15, verbose_name='Primer Nombre')
    segundoNombre = models.CharField(max_length=15, verbose_name='Segundo Nombre', default='', blank=True)
    apellido = models.CharField(max_length=15, verbose_name='Primer Apellido')
    segundoApellido = models.CharField(max_length=15, verbose_name='Segundo Apellido', default='', blank=True)
    fecha_nacimiento = models.DateField()
    ocupacion = models.CharField(max_length=15, default='No tiene')
    genero = models.CharField(max_length=10, choices=(('Femenino','Femenino'),('Masculino','Masculino')))
    estado_civil = models.CharField(max_length=10, default='Soltero', choices=(
        ('Casado','Casado'),
        ('Soltero','Soltero'),
    ...
    carnet_patria = models.CharField(max_length=10, blank=True, null=True)

    vota = models.CharField(max_length=2,default='No', choices=(
    ('Sí','Sí'),('No','No')
    ))
    centro_votacion = models.CharField(max_length=50, blank=True, null=True)
...
class JefeFamiliar(models.Model):
    ...
    direccion = models.CharField(max_length=50,verbose_name='Direccion',null=False)
    numeroCasa = models.PositiveIntegerField(max_length=3, verbose_name='Numero de Casa')
    numeroCalle = models.PositiveIntegerField( max_length=4, verbose_name = 'Numero de calle')
    def __str__(self):
